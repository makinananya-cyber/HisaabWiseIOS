...
/// system.
public struct ErrorCode: Sendable, Hashable, RawRepresentable, CustomStringConvertible {
...
extension ErrorCode {
    ...
    public static let unknown = ErrorCode(rawValue: "UNKNOWN")

    /// The response body did not match the shape the client decodes.
    public static let malformedResponse = ErrorCode(rawValue: "MALFORMED_RESPONSE")
}
